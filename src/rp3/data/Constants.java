...
public class Constants {
	...
	public static final int CLOSE_RESOURCES_ON_STOP = 2;
	public static final int CLOSE_RESOURCES_ON_PAUSE = 1;
	public static final int CLOSE_RESOURCES_ON_DESTROY = 3;

	public static final int GENERAL_TABLE_IDENTIFICATION = 11;
