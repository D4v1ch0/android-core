...
public class EnhancedListView extends ListView {
     ...
     * Pass this to {@link #setUndoStyle(rp3.widget.listview.EnhancedListView.UndoStyle)}
     ...
     * Use {@link #setSwipeDirection(rp3.widget.listview.EnhancedListView.SwipeDirection)}
    ...
    public interface OnDismissCallback {
         ...
         * depends on your data and adapter, the {@link rp3.widget.listview.EnhancedListView}
         ...
         * of {@link rp3.widget.listview.EnhancedListView.Undoable} from this method.
         ...
         * @return An {@link rp3.widget.listview.EnhancedListView.Undoable}, if you want
    ...
    public abstract static class Undoable {
         ...
         * (whereas in {@link rp3.widget.listview.EnhancedListView.OnDismissCallback#onKeyDown(int, android.view.KeyEvent)}
    ...
    private void init(Context ctx) {
        ...
        View undoView = inflater.inflate(R.layout.enhanced_undo_popup, null);
        ...
        mUndoPopup.setAnimationStyle(R.style.popup_fade_animation);
     ...
     * {@link rp3.widget.listview.EnhancedListView.OnDismissCallback#onDismiss(EnhancedListView, int)}
     * of the given {@link rp3.widget.listview.EnhancedListView} will be called. To enable
     * <i>undo</i> of the deletion, return an {@link rp3.widget.listview.EnhancedListView.Undoable}
     * from {@link rp3.widget.listview.EnhancedListView.OnDismissCallback#onDismiss(EnhancedListView, int)}.
     ...
     *
     * @return The {@link rp3.widget.listview.EnhancedListView}
     ...
     *
     * @return This {@link rp3.widget.listview.EnhancedListView}
     */
    ...
    /**
     * Sets the undo style of this list. See the javadoc of {@link rp3.widget.listview.EnhancedListView.UndoStyle}
     * for a detailed explanation of the different styles. The default style (if you never call this
     * method) is {@link rp3.widget.listview.EnhancedListView.UndoStyle#SINGLE_POPUP}.
     *
     ...
     *      is set via {@link #setDismissCallback(rp3.widget.listview.EnhancedListView.OnDismissCallback)}.
     * */
     ...
     * {@link #setSwipeDirection(rp3.widget.listview.EnhancedListView.SwipeDirection)}
     *
